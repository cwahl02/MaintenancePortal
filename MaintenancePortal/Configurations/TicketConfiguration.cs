...
public class TicketConfiguration : IEntityTypeConfiguration<Ticket>
{
    public void Configure(EntityTypeBuilder<Ticket> builder)
    {
        ...
        for (int i = 0; i < 30; i++)
        {
            var state = i % 3 == 0 ? TicketState.Open : (i % 3 == 1 ? TicketState.InProgress : TicketState.Closed);
            tickets.Add(new Ticket
            {
                ...
                ClosedAt = state == TicketState.Closed ? new DateTime(2000, 1, 2) : null,
                LastModifiedAt = new DateTime(2000, 1, 1),
